...
//证书有效结束时间
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileOutputStream outPutStream = new FileOutputStream("C:\\Users\\12733\\Desktop\\keystore.p12"); // ca.jks

        outPutStream.write(result.get("keyStoreData"));
        outPutStream.close();
        FileOutputStream fos = new FileOutputStream(new File("C:\\Users\\12733\\Desktop\\keystore.cer"));
