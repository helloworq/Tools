package com.zlutil.tools.toolpackage.ElecSign.PdfBoxWay;
...
public class PdfBoxWay {

    public static void main(String[] args) throws Exception {
        String KEYSTORE = "C:\\Users\\12733\\Desktop\\Sign\\keystore.p12";
        char[] PASSWORD = "123456".toCharArray();//keystory密码
        String SRC = "C:\\Users\\12733\\Desktop\\Sign\\57-附表国土空间规划分区.pdf";//原始pdf
        String DEST = "C:\\Users\\12733\\Desktop\\Sign\\pdfBoxDest.pdf";//签名完成的pdf
        String chapterPath = "C:\\Users\\12733\\Desktop\\Sign\\sign.jpg";//签章图片
        String signername = "周大帅";
        String reason = "数据不可更改";
        String location = "上海数慧";

        sign(new FileInputStream(SRC)
    ...
    public static void sign(InputStream src  //需要签章的pdf文件路径
        ...
        appearance.setVisibleSignature(new Rectangle(350, 290, 500, 355), 1, "sig1");
